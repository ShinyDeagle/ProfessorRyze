...
module.exports = {
  ...
  fetchKeyword: (client, message, args) => {
    function compareAndScore(input, output) {
      ...
      for (i = 0; i < out.length; i++)
        if (inputArray[i] == outputArray[i]) score++;
  ...
  fetchAll: (client, message, args) => {
    ...
    switch (args[1].toLowerCase()) {
      ...
      case "instant":
        readdirp({
          root: './GitHubDownload/src/com/nisovin/magicspells/spells/instant',
          fileFilter: '*.java'
        }, function(errors, res) {
          if (errors) {
            errors.forEach(function(err) {
      ...
      case "targeted":
        readdirp({
          root: './GitHubDownload/src/com/nisovin/magicspells/spells/targeted',
          fileFilter: '*.java'
        }, function(errors, res) {
          if (errors) {
            errors.forEach(function(err) {
      ...
      case "buff":
        readdirp({
          root: './GitHubDownload/src/com/nisovin/magicspells/spells/buff',
          fileFilter: '*.java'
        }, function(errors, res) {
          if (errors) {
            errors.forEach(function(err) {
      ...
      case "command":
        readdirp({
          root: './GitHubDownload/src/com/nisovin/magicspells/spells/command',
          fileFilter: '*.java'
        }, function(errors, res) {
          if (errors) {
            errors.forEach(function(err) {
      ...
      case "passive":
        readdirp({
          root: './GitHubDownload/src/com/nisovin/magicspells/spells/passive',
          fileFilter: '*.java'
        }, function(errors, res) {
          if (errors) {
            errors.forEach(function(err) {
      ...
      case "modifier":
        readdirp({
          root: './GitHubDownload/src/com/nisovin/magicspells/castmodifiers/conditions',
          fileFilter: '*.java'
        }, function(errors, res) {
          if (errors) {
            errors.forEach(function(err) {
